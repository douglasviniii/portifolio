...
const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: 'Online presence for Evoluação, a fifteen+ year established manufacturer of galvanized wires and industrial materials. Features product catalog, logistics fleet information, company history, and B2B contact system for industrial procurement.',
    longDescriptionPt: 'Presença online da Evoluação, fabricante estabelecida por mais de quinze anos de arames galvanizados e materiais industriais. Apresenta catálogo de produtos, informações de frota logística, história da empresa e sistema de contato B2B.',
    image: 'evoluacao.png',
  ...
  },
  {
    ...
    longDescription: 'Modern e-commerce platform for gas distribution services. Features quick order system with ten-minute delivery, customer testimonials, service options, and integrated payment processing for residential and commercial gas clients.',
    longDescriptionPt: 'Plataforma e-commerce moderna para serviços de distribuição de gás. Oferece sistema de pedidos rápido com entrega em até dez minutos, depoimentos de clientes, opções de serviço e processamento de pagamentos integrado.',
    image: 'solgas.png',
    ...
    featured: false,
    highlights: [
      'Fast ten-minute delivery system',
      'Easy order checkout',
    ...
    highlightsPt: [
      'Sistema de entrega rápida (dez min)',
              ...
              {allProjects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`absolute top-5 left-0.5 w-3 h-3 md:w-4 md:h-4 rounded-full bg-gradient-to-r ${currentColor} z-20 md:left-auto ${isLeft ? 'md:-right-8' : 'md:-left-8'}`} />
